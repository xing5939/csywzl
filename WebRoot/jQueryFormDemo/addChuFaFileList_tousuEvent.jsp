...
<title>为处罚的事件上传后续的处罚附件_投诉事件</title>
<!--对jQuery库的引用-->
...
<script type="text/javascript">
		$(document).ready(function() {
			/* 从iframe的父类窗口中读取任务id */
			 var tousuEventId = window.parent.document.getElementById("eventsId").value;
		  	 /* alert("获取的投诉任务ID"+tousuTaskId); */ 

				$.post(
					"${pageContext.request.contextPath}/showEventWfFiles.action",{id:tousuEventId},
