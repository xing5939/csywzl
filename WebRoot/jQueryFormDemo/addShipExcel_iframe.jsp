...
function showResponse(responseText, statusText, xhr, $form)  {
	...
	/* window.location.href="${pageContext.request.contextPath}/page/DataManage/DataManageShip.jsp"; */
	window.location.href="${pageContext.request.contextPath}/page/DataManage/DataExchangeShip1.jsp";
 }
 /* 当选择了文件之后，改变字体颜色 */
								...
								<div id="guocheng">
										<ol>
											...
											<ul><li>(1).参照第一行示例数据填写，此行实例数据不可删除或者修改，从第二行开始填写真实的数据。</li>
													...
													<li>(4).指定的数据项不能空缺。</li>
													<b>*部分版本的Excel需要注意:</b><ol> 【打开Excel模板，选中"船舶编号"整列，鼠标右击该列。选择"设置单元格格式"，选择"文本"类型，点击"确定"。操作完成后，即可填写信息。】</ol>
											</ul>
											<li>请将excel保存后关闭后，再导入。否则无法选择该文件。</li>
