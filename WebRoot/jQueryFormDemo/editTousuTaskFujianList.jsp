...
<script type="text/javascript">
		$(document).ready(function() {
			/* 从iframe的父类窗口中读取任务id */
			 var tousuTaskId = window.parent.document.getElementById("tousuTaskId").value;
		  	 /* alert("获取的投诉任务ID"+tousuTaskId); */ 

				$.post(
					"${pageContext.request.contextPath}/getComplainTaskFiles.action",{id:tousuTaskId},
