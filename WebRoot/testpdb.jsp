...
<body class="easyui-layout">
	...
	<table class="easyui-datagrid" title="用户列表测试样例"  id="dg" style="width:700px;height:250px" data-options="singleSelect:true,collapsible:true,url:'ListPdbAction.action',method:'get',
